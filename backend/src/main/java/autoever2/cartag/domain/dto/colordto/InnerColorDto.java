...
public class InnerColorDto {
    @Schema(description = "내부 색상 이름", nullable = true)
    private String colorName;
    @Schema(description = "내부 색상 이미지 url", nullable = true)
    private String colorImage;
    @Schema(description = "내부 색상 이미지 가격", nullable = true)
    private Long colorPrice;
    @Schema(description = "판매된 내부 색상 이미지", nullable = true)
    private Long colorBoughtCount;
    @Schema(description = "차량에 적용된 내부 색상 이미지 url", nullable = true)
